...
#require_relative '../../hiera-aws-secretsmanager-helper'

Puppet::Functions.create_function(:hiera_aws_secretsmanager_old) do
  ...
  def lookup_key(key, options, context)
    ...
    #@hasm = HieraAwsSecretsManagerHelper.new(options, context)
